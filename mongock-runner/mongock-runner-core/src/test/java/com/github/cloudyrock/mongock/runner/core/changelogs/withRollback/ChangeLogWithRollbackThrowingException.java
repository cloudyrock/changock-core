...
@ChangeLog(order = "1")
public class ChangeLogWithRollbackThrowingException {
  ...
  public void changeSetFailing1() {
    if(true) throw new RuntimeException("Expected exception in " + ChangeLogWithRollbackThrowingException.class + " changeLog[ChangeSet]");
  }

  @Rollback("changeset_with_rollback_1")
  public void rollbackChangeSetFailing1() {
    rollbackCalledLatch.countDown();
    if(true) throw new RuntimeException("Expected exception in " + ChangeLogWithRollbackThrowingException.class + " changeLog[rollback]");
  }
