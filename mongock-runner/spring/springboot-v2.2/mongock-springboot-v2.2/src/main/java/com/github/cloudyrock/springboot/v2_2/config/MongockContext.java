...
import com.github.cloudyrock.springboot.v2_2.SpringbootV2_2BuilderBase;
...
public class MongockContext {
  ...
  public SpringbootV2_2BuilderBase.MongockApplicationRunner applicationRunner(ConnectionDriver connectionDriver,
  ...
  public SpringbootV2_2BuilderBase.MongockInitializingBeanRunner initializingBeanRunner(ConnectionDriver connectionDriver,
                                                                                        MongockSpringConfiguration springConfiguration,
                                                                                        ApplicationContext springContext,
                                                                                        ApplicationEventPublisher applicationEventPublisher) {
    return getBuilder(connectionDriver, springConfiguration, springContext, applicationEventPublisher)
