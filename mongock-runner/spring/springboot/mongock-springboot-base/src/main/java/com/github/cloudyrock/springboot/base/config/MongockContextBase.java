...
import com.github.cloudyrock.springboot.base.SpringbooBuilderBase;
...
public abstract class MongockContextBase<CONFIG extends MongockSpringConfigurationBase> {
  ...
  public SpringbooBuilderBase.MongockApplicationRunnerBase applicationRunner(ConnectionDriver connectionDriver,
  ...
  public SpringbooBuilderBase.MongockInitializingBeanRunnerBase initializingBeanRunner(ConnectionDriver connectionDriver,
                                                                                       CONFIG springConfiguration,
                                                                                       ApplicationContext springContext,
                                                                                       ApplicationEventPublisher applicationEventPublisher) {
    return getBuilder(connectionDriver, springConfiguration, springContext, applicationEventPublisher)
  ...
  protected abstract SpringbooBuilderBase getBuilder(ConnectionDriver connectionDriver,
                                                     CONFIG springConfiguration,
                                                     ApplicationContext springContext,
                                                     ApplicationEventPublisher applicationEventPublisher);
}
