...
import io.changock.driver.mongo.springdata.v3.driver.decorator.impl.BulkOperationsDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.impl.CloseableIteratorDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.impl.IndexOperationsDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.impl.MongoOperationsDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.impl.ScriptOperationsDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.impl.SessionScopedDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.operation.executable.aggregation.impl.ExecutableAggregationDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.operation.executable.find.impl.ExecutableFindDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.operation.executable.insert.impl.ExecutableInsertDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.operation.executable.mapreduce.impl.MapReduceWithMapFunctionDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.operation.executable.remove.impl.ExecutableRemoveDecoratorImpl;
import io.changock.driver.mongo.springdata.v3.driver.decorator.operation.executable.update.impl.ExecutableUpdateDecoratorImpl;
...
public interface MongoOperationsDecorator extends MongoOperations {
  ...
  @Override
  default <T> T findAndModify(Query query, UpdateDefinition update, FindAndModifyOptions options, Class<T> entityClass) {
    return getInvoker().invoke(()-> getImpl().findAndModify(query, update, options, entityClass));
  }

  @Override
  default <T> T findAndModify(Query query, UpdateDefinition update, FindAndModifyOptions options, Class<T> entityClass, String collectionName) {
  ...
  @Override
  default <T> T findAndReplace(Query query, T replacement, FindAndReplaceOptions options, Class<T> entityType, String collectionName) {
    return getInvoker().invoke(()-> getImpl().findAndReplace(query, replacement, options, entityType, collectionName));
  }

  @Override
  default  <S, T> T findAndReplace(Query query, S replacement, FindAndReplaceOptions options, Class<S> entityType, Class<T> resultType) {
