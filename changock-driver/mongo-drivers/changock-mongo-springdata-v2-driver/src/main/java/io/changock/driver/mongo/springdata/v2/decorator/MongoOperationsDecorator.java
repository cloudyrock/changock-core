...
import io.changock.driver.mongo.springdata.v2.decorator.impl.ScriptOperationsDecoratorImpl;
...
public interface MongoOperationsDecorator extends MongoOperations {
    ...
    //TODO create interceptor for MapReduceWithMapFunction
    @Override
    ...
    //TODO create interceptor for sessionScoped
    @Override
