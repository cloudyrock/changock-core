...
/**
 * Set of changes inside a changelog that will be performed in first place, before the proper migration.
...
public @interface BeforeChangeSets {

  /**
   * Author of the pre-transaction.
   * Obligatory
   *
   * @return author
   */
  ...
  /**
   * Unique ID of the pre-transaction.
   * Obligatory
   *
   * @return unique id
   */
  ...
  /**
   * Sequence that provide correct order for pre-transactions. Sorted alphabetically, ascending.
   * Obligatory.
   *
   * @return ordering
   */
  ...
  /**
   * Specifies the software systemVersion on which the pre-transaction is to be applied.
  ...
  /**
   * If true, will make the entire migration to break if the pre-transaction produce an exception or the validation doesn't
